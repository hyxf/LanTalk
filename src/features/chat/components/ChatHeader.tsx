...
import { Users, Search, Share2, Moon, Sun, ChevronUp, ChevronDown, X } from 'lucide-react'
...
export const ChatHeader = ({ onMenuClick, onJumpTo }: ChatHeaderProps) => {
  ...
  const headerTitle =
    peers.length > 0 ? peers.map(u => u.name).join(', ') : 'Waiting for someone...'
  const statusColor =
  ...
  return (
    <div className="chat-header">
          ...
          <div className="header-left">
            ...
            <div className="header-title">
              ...
              <div
                ...
                style={{ color: isAnyoneTyping ? 'var(--text-secondary)' : statusColor }}
              >
                {isAnyoneTyping ? (
      ...
      {shareOpen && createPortal(<ShareModal onClose={() => setShareOpen(false)} />, document.body)}
    </div>
  )
}
